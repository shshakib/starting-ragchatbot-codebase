...
class CourseOutlineTool(Tool):
    """Tool for retrieving a course outline from the course metadata catalog"""
    ...
    def get_tool_definition(self) -> Dict[str, Any]:
        return {
            ...
            "description": "Get the complete outline for a course: title, course link, and numbered lesson list",
            "input_schema": {
                "type": "object",
                "properties": {
                    "course_name": {
